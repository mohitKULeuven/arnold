...
class Node: 
    ...
    def __init__(self ,data): 
        self.E = copy.deepcopy(data[0])
        self.EM = copy.deepcopy(data[1])
        self.ES = copy.deepcopy(data[2])
        self.F = copy.deepcopy(data[3])
        self.FM = copy.deepcopy(data[4])
        self.FS = copy.deepcopy(data[5])
        self.Z = copy.deepcopy(data[6])
        self.ZM = copy.deepcopy(data[7]) 
